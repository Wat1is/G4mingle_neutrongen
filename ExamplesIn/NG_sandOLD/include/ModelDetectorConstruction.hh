...
#ifndef ModelDetectorConstruction_h
#define ModelDetectorConstruction_h 1
...
class ModelDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    ModelDetectorConstruction();
    virtual ~ModelDetectorConstruction();
  ...
  private:
	...
	static G4ThreadLocal F05Field* fEMfield;
